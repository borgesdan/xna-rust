...
use windows::Win32::Graphics::Dxgi::{DXGI_SCALING, DXGI_SURFACE_DESC, DXGI_SWAP_EFFECT, DXGI_SWAP_EFFECT_DISCARD, DXGI_SWAP_EFFECT_FLIP_DISCARD, DXGI_SWAP_EFFECT_FLIP_SEQUENTIAL, DXGI_SWAP_EFFECT_SEQUENTIAL, DXGI_USAGE, DXGI_USAGE_BACK_BUFFER, DXGI_USAGE_DISCARD_ON_PRESENT, DXGI_USAGE_READ_ONLY, DXGI_USAGE_RENDER_TARGET_OUTPUT, DXGI_USAGE_SHADER_INPUT, DXGI_USAGE_SHARED, DXGI_USAGE_UNORDERED_ACCESS};
use crate::xna::framework::graphics::{Blend, BlendFunction, ColorWriteChannels, ComparisonFunction, CullMode, DisplayMode, DisplayModeScaling, FillMode, Scaling, ScanlineOrder, StencilOperation, SurfaceFormat, SurfaceUsage, SwapEffect, TextureAddressMode, TextureFilter};
    ...
    pub fn to_dx(&self) -> DXGI_MODE_DESC {
        DXGI_MODE_DESC {
            ...
            RefreshRate: DXGI_RATIONAL {
                Denominator: self.refresh_rate.denominator,
                Numerator: self.refresh_rate.numerator,
            },
